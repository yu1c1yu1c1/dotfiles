...
--     local pane_info = window:active_pane()
--     -- ペインのIDやタイトルをステータスバーに表示
--     window:set_left_status(wezterm.format({
--         { Text = ' Pane ID: ' .. pane:pane_id() .. ' ' },
--     }))
-- end)
    ...
    keys = {
        ...
        -- Pane番号表示
        {
            ...
            action = act.PaneSelect {
                alphabet = '123456789', -- ラベルを数字にしたい場合はここを指定（デフォルトはアルファベット）
                mode = 'Activate',      -- 'Activate' は移動、'SwapWithActive' は入れ替え
            },
        },
        -- Pane選択
